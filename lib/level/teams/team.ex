defmodule Level.Teams.Team do
  @moduledoc """
  A Team is the fundamental unit in Level. Think of a team like an "organization"
  ...
  schema "teams" do
    ...
    field :name, :string
    field :slug, :string
    has_many :users, Level.Teams.User
...
defimpl Phoenix.Param, for: Level.Teams.Team do
