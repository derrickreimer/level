defmodule NeuronWeb.Router do
  use NeuronWeb, :router
  ...
  scope "/" do
    ...
    forward "/graphql", Absinthe.Plug, schema: NeuronWeb.Schema
  end

  # Launcher-scoped routes
  scope "/", NeuronWeb, host: "launch." do
