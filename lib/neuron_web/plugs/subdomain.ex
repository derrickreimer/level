defmodule NeuronWeb.Subdomain do
  @moduledoc """
  ...
  def validate_host(conn, _opts \\ []) do
    cond do
      conn.host == "localhost" ->
        raise """
        Serving Neuron over localhost is not supported.

        Neuron relies on subdomains for routing. Configure your hosts accordingly.
        See https://github.com/djreimer/neuron#routing for more information.
        """
      ...
      true ->
        raise """
        Neuron must be served from the hostname configured in your config/{env}.exs file.
