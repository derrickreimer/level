defmodule NeuronWeb.Schema do
  @moduledoc """
  GraphQL schema.
  """

  use Absinthe.Schema
  import_types NeuronWeb.Schema.Types
  ...
  mutation do
    ...
    field :invite_user, type: :invite_user_payload do
      ...
      resolve &NeuronWeb.InvitationResolver.create/2
    end
    ...
    field :create_draft, type: :create_draft_payload do
      ...
      resolve &NeuronWeb.DraftResolver.create/2
    end
    ...
    field :update_draft, type: :update_draft_payload do
      ...
      resolve &NeuronWeb.DraftResolver.update/2
    end
    ...
    field :delete_draft, type: :delete_draft_payload do
      ...
      resolve &NeuronWeb.DraftResolver.destroy/2
    end
  end
end
