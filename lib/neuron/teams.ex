defmodule Neuron.Teams do
  @moduledoc """
  A team is the fundamental organizational unit in Neuron. Think of a team like
  ...
  def create_invitation(changeset) do
    case Repo.insert(changeset) do
      {:ok, invitation} ->
        ...
        invitation
        |> NeuronWeb.Email.invitation_email()
        |> Neuron.Mailer.deliver_later()
