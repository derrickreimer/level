defmodule Sprinkle.Teams do
  @moduledoc """
  A team is the fundamental organizational unit in Sprinkle. Think of a team like
  ...
  alias Sprinkle.Teams.Registration
  alias Sprinkle.Teams.Invitation
  alias Sprinkle.Repo
  ...
  def create_invitation(changeset) do
    case Repo.insert(changeset) do
      {:ok, invitation} ->
        ...
        invitation
        |> SprinkleWeb.Email.invitation_email()
        |> Sprinkle.Mailer.deliver_later()
