defmodule BridgeWeb.Router do
  ...
  scope "/" do
    ...
    forward "/graphql", Absinthe.Plug, schema: BridgeWeb.Schema
  end

  # Launcher-scoped routes
  scope "/", BridgeWeb, host: "launch." do
