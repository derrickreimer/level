defmodule SprinkleWeb.Router do
  use SprinkleWeb, :router
  ...
  scope "/" do
    ...
    forward "/graphql", Absinthe.Plug, schema: SprinkleWeb.Schema
  end

  # Launcher-scoped routes
  scope "/", SprinkleWeb, host: "launch." do
