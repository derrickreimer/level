defmodule SprinkleWeb.Auth do
  ...
  """
  def jwt_secret do
    Application.get_env(:sprinkle, SprinkleWeb.Endpoint)[:secret_key_base]
  end
      ...
      ["Bearer " <> token] ->
        case verify_signed_jwt(token) do
          %Joken.Token{claims: %{"sub" => user_id}, error: nil} ->
            user = Repo.get(Sprinkle.Teams.User, user_id)
