defmodule SprinkleWeb.Subdomain do
  @moduledoc """
  ...
  def validate_host(conn, _opts \\ []) do
    cond do
      conn.host == "localhost" ->
        raise """
        Serving Sprinkle over localhost is not supported.

        Sprinkle relies on subdomains for routing. Configure your hosts accordingly.
        See https://github.com/djreimer/sprinkle#routing for more information.
        """
      ...
      true ->
        raise """
        Sprinkle must be served from the hostname configured in your config/{env}.exs file.
