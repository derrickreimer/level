defmodule SprinkleWeb.AuthTest do
  use SprinkleWeb.ConnCase
  alias SprinkleWeb.Auth
  ...
  describe "sign_out/2" do
    test "signs out of the given team only", %{conn: conn} do
      team1 = %Sprinkle.Teams.Team{id: 1}
      team2 = %Sprinkle.Teams.Team{id: 2}

      user1 = %Sprinkle.Teams.User{id: 1}
      user2 = %Sprinkle.Teams.User{id: 2}
  ...
  describe "generate_signed_jwt/1" do
    setup do
      user = %Sprinkle.Teams.User{id: 999}
      {:ok, %{user: user}}
    end
