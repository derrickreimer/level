defmodule Sprinkle.ThreadsTest do
  use Sprinkle.DataCase
  ...
  describe "create_draft_changeset/1" do
    setup do
      ...
      team = %Sprinkle.Teams.Team{id: 888}
  ...
  describe "get_draft_for_user/1" do
    ...
    test "handles when the draft does not belong to the user", %{draft: draft} do
      assert Threads.get_draft_for_user(%Sprinkle.Teams.User{id: 999}, draft.id) == nil
    end
