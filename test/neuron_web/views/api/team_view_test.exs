defmodule NeuronWeb.API.TeamViewTest do
  ...
  describe "render/2 create.json" do
    test "includes the new team" do
      user = %Neuron.Teams.User{email: "derrick@neuron.chat"}
      team = %Neuron.Teams.Team{slug: "neuron"}
  ...
  describe "team_json/1" do
    test "includes team attributes" do
      ...
      assert TeamView.team_json(team) ==
        %{id: 999, name: "Neuron", slug: "neuron",
