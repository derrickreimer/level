defmodule NeuronWeb.AuthTest do
  ...
  describe "sign_out/2" do
    test "signs out of the given team only", %{conn: conn} do
      team1 = %Neuron.Teams.Team{id: 1}
      team2 = %Neuron.Teams.Team{id: 2}

      user1 = %Neuron.Teams.User{id: 1}
      user2 = %Neuron.Teams.User{id: 2}
