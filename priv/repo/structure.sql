...
--
-- Name: group_user_access; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.group_user_access AS ENUM (
    'PUBLIC',
    'PRIVATE'
);
...
--
-- Name: notification_event; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: notification_state; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: digest_posts; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.digest_posts (
    ...
    digest_section_id uuid NOT NULL,
...
CREATE TABLE public.group_users (
    ...
    access public.group_user_access DEFAULT 'PUBLIC'::public.group_user_access NOT NULL
);
...
CREATE TABLE public.notifications (
    ...
    space_user_id uuid NOT NULL,
    topic text NOT NULL,
    state public.notification_state DEFAULT 'UNDISMISSED'::public.notification_state NOT NULL,
...
--
-- Name: digest_posts digest_posts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: digests_space_user_id_key_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX digests_space_user_id_key_index ON public.digests USING btree (space_user_id, key);
...
--
-- Name: digest_posts digest_posts_digest_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digest_posts
    ADD CONSTRAINT digest_posts_digest_id_fkey FOREIGN KEY (digest_id) REFERENCES public.digests(id);


--
-- Name: digest_posts digest_posts_digest_section_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digest_posts
    ADD CONSTRAINT digest_posts_digest_section_id_fkey FOREIGN KEY (digest_section_id) REFERENCES public.digest_sections(id);


--
-- Name: digest_posts digest_posts_post_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.digest_posts
    ADD CONSTRAINT digest_posts_post_id_fkey FOREIGN KEY (post_id) REFERENCES public.posts(id);


--
-- Name: digest_posts digest_posts_space_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.notifications
    ADD CONSTRAINT notifications_space_id_fkey FOREIGN KEY (space_id) REFERENCES public.spaces(id);


--
-- Name: notifications notifications_space_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.notifications
    ADD CONSTRAINT notifications_space_user_id_fkey FOREIGN KEY (space_user_id) REFERENCES public.space_users(id);


--
-- Name: nudges nudges_space_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nudges
    ADD CONSTRAINT nudges_space_id_fkey FOREIGN KEY (space_id) REFERENCES public.spaces(id);


--
-- Name: nudges nudges_space_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nudges
    ADD CONSTRAINT nudges_space_user_id_fkey FOREIGN KEY (space_user_id) REFERENCES public.space_users(id);
...
ALTER TABLE ONLY public.post_log
    ADD CONSTRAINT post_log_actor_id_fkey FOREIGN KEY (space_user_id) REFERENCES public.space_users(id);
...
--
-- Name: post_log post_log_space_bot_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.post_log
    ADD CONSTRAINT post_log_space_bot_id_fkey FOREIGN KEY (space_bot_id) REFERENCES public.space_bots(id);
