...
CREATE TABLE public.users (
    ...
    has_chosen_handle boolean DEFAULT true NOT NULL
);
...
ALTER TABLE ONLY public.spaces
    ADD CONSTRAINT spaces_org_id_fkey FOREIGN KEY (org_id) REFERENCES public.orgs(id);
