module Icons exposing (Toggle(..), arrowLeft, arrowRight, arrowUpRight, atSign, bookmark, check, checkSquare, closed, closedAvatar, comment, file, filter, heart, image, inboxWhite, lock, logOut, logo, open, refresh, reply, revokeMember, search, square, thumbs, undismissed, unlock)
...
thumbs toggle =
    case toggle of
        On ->
            iconView <|
                svg [ width "18px", height "18px", viewBox "0 0 18 18", version "1.1" ] [ g [ id "Page-1", stroke "none", strokeWidth "1", fill "none", fillRule "evenodd", strokeLinecap "round", strokeLinejoin "round" ] [ g [ id "thumbs-up-filled", transform "translate(1.000000, 1.000000)", fill "#12C1D5", stroke "#12C1D5", strokeWidth "2" ] [ Svg.path [ d "M9.1451045,5.24996596 L9.1451045,2.24998541 C9.1451045,1.00735278 8.12150381,6.66133815e-16 6.85882838,0 L3.81046021,6.74995624 L3.81046021,16 L13.4068584,15.9999028 C14.1668827,16.0083585 14.8170802,15.4644633 14.9310425,14.724911 L15.9827295,6.97495478 C16.0498363,6.53984909 15.9193975,6.09769207 15.6259626,5.76559838 C15.3325277,5.43350468 14.9057043,5.24498251 14.4585455,5.24996596 L9.1451045,5.24996596 Z M3.81046021,15.9999028 L1.52418408,15.9999028 C0.682400458,15.9999028 0,15.3283342 0,14.4999125 L0,8.24994652 C-1.69218426e-16,7.42152476 0.682400458,6.74995624 1.52418408,6.74995624 L3.81046021,6.74995624 L3.81046021,15.9999028 Z", id "Shape" ] [] ] ] ]

        Off ->
            iconView <|
                svg [ width "18px", height "18px", viewBox "0 0 18 18", version "1.1" ] [ g [ id "Page-1", stroke "none", strokeWidth "1", fill "none", fillRule "evenodd", strokeLinecap "round", strokeLinejoin "round" ] [ g [ id "thumbs-up", transform "translate(1.000000, 1.000000)", stroke "#8A98A5", strokeWidth "2" ] [ Svg.path [ d "M9.1451045,5.24996596 L9.1451045,2.24998541 C9.1451045,1.00735278 8.12150381,6.66133815e-16 6.85882838,0 L3.81046021,6.74995624 L3.81046021,16 L13.4068584,15.9999028 C14.1668827,16.0083585 14.8170802,15.4644633 14.9310425,14.724911 L15.9827295,6.97495478 C16.0498363,6.53984909 15.9193975,6.09769207 15.6259626,5.76559838 C15.3325277,5.43350468 14.9057043,5.24498251 14.4585455,5.24996596 L9.1451045,5.24996596 Z M3.81046021,15.9999028 L1.52418408,15.9999028 C0.682400458,15.9999028 0,15.3283342 0,14.4999125 L0,8.24994652 C-1.69218426e-16,7.42152476 0.682400458,6.74995624 1.52418408,6.74995624 L3.81046021,6.74995624 L3.81046021,15.9999028 Z", id "Shape" ] [] ] ] ]
