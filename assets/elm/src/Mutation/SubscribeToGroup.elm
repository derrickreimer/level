module Mutation.SubscribeToGroup exposing (Response(..), request)
...
successDecoder =
    Decode.at [ "data", "subscribeToGroup" ] <|
        Decode.map Success <|
...
failureDecoder =
    Decode.map Invalid <|
        Decode.at [ "data", "subscribeToGroup", "errors" ]
        ...
        conditionalDecoder success =
            case success of
                ...
                False ->
                    failureDecoder
    in
    Decode.at [ "data", "subscribeToGroup", "success" ] Decode.bool
