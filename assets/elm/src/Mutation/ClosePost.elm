module Mutation.ClosePost exposing (Response(..), request)
...
successDecoder =
    Decode.map Success <|
        Decode.at [ "data", "closePost", "post" ] Post.decoder


failureDecoder : Decoder Response
failureDecoder =
    Decode.map Invalid <|
        Decode.at [ "data", "closePost", "errors" ] (Decode.list ValidationError.decoder)
        ...
        conditionalDecoder success =
            case success of
                ...
                False ->
                    failureDecoder
    in
    Decode.at [ "data", "closePost", "success" ] Decode.bool
