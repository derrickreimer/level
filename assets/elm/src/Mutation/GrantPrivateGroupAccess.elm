module Mutation.GrantPrivateGroupAccess exposing (Response(..), request, variables)
...
failureDecoder =
    Decode.map Invalid <|
        Decode.at [ "data", "grantPrivateGroupAccess", "errors" ] (Decode.list ValidationError.decoder)
        ...
        conditionalDecoder success =
            case success of
                ...
                False ->
                    failureDecoder
    in
    Decode.at [ "data", "grantPrivateGroupAccess", "success" ] Decode.bool
